...
//				2023-07-24 여기서부터 다시 버튼 클릭시 컨테이너,다이어로그는 메인창이 1개밖에 안 됨으로 다른 방법으로 기존 로그인 창을 종료시키고
//				haksa프로그램 visual true로 해주기 pageAppearing얘를 지금 haksa에서 false로 잡아놔서 안 나오도록 설정 해놨음
					...
					if(o.db.logincheck(uid, upass)) {	//이 부분이 데이터베이스에 접속해 로그인 정보를 확인하는 부분이다.
						...
						setVisible(false);
						haksa.setVisible(true);
						
//						panel.add(new Haksa());
//						haksa.pageAppearing = true;
					} else {
